...
class FibonacciChecker:
    ...
    def check_number(cls, number: int) -> str:
        """
        Verifica se o número pertence à sequência e retorna uma mensagem formatada.
        ...
        try:
            ...
            if is_fib:
                position = sequence.index(number)  # Corrigido: posição correta na sequência
                return (
                ...
                # Se o número não pertence à sequência, mostre em qual intervalo ele se encontra
                return (
